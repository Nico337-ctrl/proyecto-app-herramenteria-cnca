    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="container__form">
            <div class="form__container">
                <p class="title">Herramenteria CNCA</p>
                    ...
                    <div class="input-group">
                        ...
                        {{-- <div class="forgot">
                            <a rel="noopener noreferrer" href="#">Olvidé mi contraseña</a>
                        </div> --}}
                ...
                <!-- <p class="signup">¿No tienes una cuenta?
                    <a rel="noopener noreferrer" href="#" class="">Registrate</a>
                </p> -->
                
            </div>

            <div class="image__container">
                <!-- <img src="/img/herramientas.avif" alt="Imagen de fondo"> -->
            </div>
        </div>
    </form>
@endsection
