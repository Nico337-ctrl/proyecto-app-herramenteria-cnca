...
<div class="container py-4">
    ...
    <a id="newMt" href="#" data-toggle="modal" data-target="#ModalCreate" class="btn btn-primary btn-sm">Ingresar nuevo
        material</a>
    @endcan
    ...
    <table id="tableH" class="table table-hover">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="btn-s">
                    {{-- <a href="{{ url('matConsumible/'.$matConsumible->id.'/edit' ) }}"
                        class="btn btn-warning btn-sn" data-toggle="modal" data-target="#ModalEdit"
                        data-id="{{ $matConsumible->id }}"><i class="fa-solid fa-pen-to-square"></i></a> --}}
                    @can('matConsumible.edit')
                    <a href="#" class="btn btn-warning btn-sn edit-button" data-toggle="modal"
                        data-target="#ModalEdit_{{ $matConsumible->id }}" data-id="{{ $matConsumible->id }}">
                        <i class="fa-solid fa-pen-to-square"></i>
                    </a>
                    <form class="form__update" action="{{ url('matConsumible/'.$matConsumible->id) }}" method="post"
                        enctype="multipart/form-data" >
                        <div class="modal fade text-left" id="ModalEdit_{{ $matConsumible->id }}" tabindex="-1"
                                        ...
                                        <div class="md-3 row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" name="codigo" id="codigo"
                                                    value="{{ $matConsumible->codigo }}" required>
                                            </div>
                                        </div>
                                        <div class="md-3 row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" name="descripcion"
                                                    id="descripcion" value="{{ $matConsumible->descripcion }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="md-3 row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" name="estante" id="estante"
                                                    value="{{ $matConsumible->estante }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="md-3 row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" name="gaveta" id="gaveta"
                                                    value="{{ $matConsumible->gaveta }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="md-3 row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" name="medida" id="medida"
                                                    value="{{ $matConsumible->medida }}" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="md-3 row">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="text" class="form-control" name="cantidad" id="cantidad"
                                                    value="{{ $matConsumible->cantidad }}" required>
                                            </div>
                                        </div>
...
<script>
    $('.form__update').submit(function (e) {
        ...
        Swal.fire({
            title: "¿Estás seguro?",
            text: "Este material se modificara",
            icon: "warning",
            showCancelButton: true,
            confirmButtonColor: "#3085d6",
            cancelButtonColor: "#d33",
...
<script>
    Swal.fire({
        ...
        text: "Su material ha sido modificada con éxito.",
        icon: "success"
    });
</script>
@endif
